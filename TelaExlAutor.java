 ...
 * @author mpgab
 */
public class TelaExlAutor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Excluir pelo nome");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if(Main.memoria.exlAutor(lblNome.getText())){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExlAutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaExlAutor().setVisible(true);
            }
        });
    }
